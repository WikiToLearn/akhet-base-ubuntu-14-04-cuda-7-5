...
RUN apt-get update && apt-get -y --force-yes install python-pip && rm -f /var/cache/apt/archives/*deb && find /var/lib/apt/lists/ -type f -delete && find /var/log/ -type f -delete
